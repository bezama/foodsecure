<?php
    ...
    class AccountsDemoDataMaker extends DemoDataMaker
    {
        ...
        public function populateModel(& $model)
        {
            ...
            $accountRandomData = fosaRandomDataUtil::getRandomDataByModuleAndModelClassNames('AccountsModule', 'Account');
            ...
            $model->billingAddress  = fosaRandomDataUtil::makeRandomAddress();
