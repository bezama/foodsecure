<?php
     ...
     */
    class AccountsRegularUserWalkthroughTest extends fosaRegularUserWalkthroughBaseTest
    {
        ...
        public function testRegularUserBullkWriteWhereSomeItemsTheyDontHavePrivledgesToDoIt()
        {
            ...
            $this->assertEquals(Right::DENY, $confused->getEffectiveRight('fosaModule', fosaModule::RIGHT_BULK_WRITE));
            $confused->setRight('fosaModule', fosaModule::RIGHT_BULK_WRITE);
            $this->assertTrue($confused->save());
