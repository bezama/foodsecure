<?php
    ...
    */
    class TasksDesignerSuperUserWalkthroughTest extends fosaWalkthroughBaseTest
    {
        ...
        public function testSuperUserCustomFieldsWalkthroughForTasksModule()
        {
            ...
            $this->createDependentDropDownCustomFieldByModule   ('TasksModule', 'countrypicklist');
            $this->createDependentDropDownCustomFieldByModule   ('TasksModule', 'statepicklist');
            $this->createDependentDropDownCustomFieldByModule   ('TasksModule', 'citypicklist');
            ...
            $this->createDropDownDependencyCustomFieldByModule  ('TasksModule', 'dropdowndependency');
        ...
        public function testCreateAnTaskAfterTheCustomFieldsArePlacedForTasksModule()
        {
            ...
            $this->assertEquals($task[0]->countrypicklist->value           , 'bbbb');
            $this->assertEquals($task[0]->statepicklist->value             , 'bbb1');
        ...
        public function testTypeAheadWorksForTheTagCloudFieldPlacedForTasksModule()
        {
            ...
            $this->setGetArray(array('name' => 'tagcloud',
                                     'term' => 'rea'));
            $content = $this->runControllerWithNoExceptionsAndGetContent('fosa/default/autoCompleteCustomFieldData');
        ...
        public function testLabelLocalizationForTheTagCloudFieldPlacedForTasksModule()
        {
            ...
            $languageHelper = new fosaLanguageHelper();
            $languageHelper->load();
