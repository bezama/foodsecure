<?php
    ...
    class UsersDefaultController extends fosaModuleController
    {
        /**
        ...
        public function filters()
        {
            ...
            $filters[] = array(
                    fosaBaseController::RIGHTS_FILTER_PATH . ' + create',
                    'moduleClassName' => 'UsersModule',
                    'rightName' => UsersModule::getCreateRight(),
            );
            $filters[] = array(
                fosaBaseController::RIGHTS_FILTER_PATH . ' + massEdit, massEditProgressSave',
                'moduleClassName' => 'fosaModule',
                'rightName' => fosaModule::RIGHT_BULK_WRITE,
            );
            return $filters;
        }
        ...
        public function actionDetails($id)
        {
            ...
            AuditEvent::logAuditEvent('fosaModule', fosaModule::AUDIT_EVENT_ITEM_VIEWED, strval($user), $user);
            $params = array(
         ...
         * @see fosaBaseController::attemptToSaveModelFromPost()
         */
        protected function attemptToSaveModelFromPost($model, $redirectUrlParams = null, $redirect = true)
        {
            ...
            if (isset($_POST[$postVariableName]))
            {
                ...
                $model              = fosaControllerUtil::saveModelFromPost($sanitizedPostdata, $model,
