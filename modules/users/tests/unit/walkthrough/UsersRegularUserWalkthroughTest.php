<?php
     ...
     */
    class UsersRegularUserWalkthroughTest extends fosaRegularUserWalkthroughBaseTest
    {
        ...
        public function testBulkWriteSecurityCheck()
        {
            ...
            $this->assertEquals(Right::DENY, $aUser->getEffectiveRight('fosaModule', fosaModule::RIGHT_BULK_WRITE));
            $aUser->setRight('fosaModule', fosaModule::RIGHT_BULK_WRITE);
