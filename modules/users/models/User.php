    ...
    class User extends Permitable
    {
        ...
        protected function logAuditEventsListForCreatedAndModifed($newModel)
        {
            if ($newModel)
            {
                ...
                AuditEvent::logAuditEvent('fosaModule', fosaModule::AUDIT_EVENT_ITEM_CREATED, strval($this), $this);
            }
            else
            {
            ...
            assert('$rightName  != ""');
                ...
                else
                {
                    ...
                    catch (NotFoundException $e)
                    {
                        ...
                        assert('$this->id > 0');
                        $actualRight     = intval(fosaDatabaseCompatibilityUtil::
        ...
        public function getPropagatedActualAllowRight($moduleName, $rightName)
        {
            ...
            else
            {
                ...
                // anything not saved will not work.
                assert('$this->id > 0');
                return intval(fosaDatabaseCompatibilityUtil::
