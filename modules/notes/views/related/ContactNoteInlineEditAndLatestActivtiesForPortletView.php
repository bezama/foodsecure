<?php
    ...
    /**
     * Wrapper view for displaying an contact's note edit form and latest activities feed.
     */
    class ContactNoteInlineEditAndLatestActivtiesForPortletView extends NoteInlineEditAndLatestActivtiesForPortletView
    {
